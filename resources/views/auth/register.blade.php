            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="staff_number" class="col-md-4 col-form-label text-md-end">{{ __('スタッフNo,(5桁)') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">{{ __('パスワード(8文字以上)') }}</label>
